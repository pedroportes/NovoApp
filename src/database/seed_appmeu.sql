DO $$
DECLARE
    v_empresa_id UUID := 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee';
    v_tecnico_id UUID := '10aef746-8561-453a-80ef-06819c2670f3';
    v_cliente_id UUID;
    i INT;
BEGIN
    ...
    IF v_cliente_id IS NULL THEN
        INSERT INTO clientes (id, nome_razao, empresa_id, email, created_at, nome_razao)
        VALUES (gen_random_uuid(), 'Cliente Demo', v_empresa_id, 'demo@cliente.com', NOW(), 'Cliente Demo')
        RETURNING id INTO v_cliente_id;
    END IF;

    -- 2. Seed Service Orders (For Top Cards - Revenue)
    -- Insert 3 completed OS for CURRENT MONTH
    FOR i IN 1..3 LOOP
    ...
    -- 3. Seed Financial Flow (For Chart - History)
